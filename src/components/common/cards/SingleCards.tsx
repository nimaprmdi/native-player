...
const SingleCards = ({ icon, title, btnText, url, functional }: SingleCardsProps) => {
    return (
        <>
            <div className="c-single-card w-1/4 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-dark dark:border-gray-700 py-10">
